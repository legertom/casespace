  ...
  return (
    <div>
      ...
      <p className="mt-2 max-w-prose text-ink-muted">
        Twenty ways to draw the pipeline, the one that shipped, and why. Every
        drawing on this page reads the live casebook — switch the data at the
        top and they all redraw together, which is how they were compared in the
        first place.
      </p>
      <div className="mt-10">
