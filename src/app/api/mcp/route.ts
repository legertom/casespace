  ...
  (server) => {
    ...
    server.registerTool(
      "get_progress",
      {
        ...
        description:
          "The program scoreboard: documented (45) and confirmed-positive-ROI (15) counts, what is in flight behind them, pipeline, per-ELT-org and per-team splits, and attention flags.",
        inputSchema: z.object({}),
      },
